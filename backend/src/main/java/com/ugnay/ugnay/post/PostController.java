...
public class PostController {
    ...
    public record CreatePostRequest(
        ...
        UUID mediaAssetId, List<UUID> mediaAssetIds, String scheduledAt,   // ISO-8601
        UUID orgId
    ) {}

    public record PostDto(
        UUID id, String caption, String[] hashtags, String tone,
        String status, String scheduledAt, String mediaUrl, List<String> mediaUrls,
        List<UUID> mediaAssetIds, String fbPostId, UUID orgId
    ) {}
}